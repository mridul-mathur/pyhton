...
URL1 = 'https://www.googleapis.com/youtube/v3/playlistItems?part=contentDetails&maxResults=50&fields=items' \
       '/contentDetails/videoId,nextPageToken&key={}&playlistId={}&pageToken= '
...
def static_from_root():
    return Response(
        ...
        'aae68b8a5242a8e5f0505ee6eaa406bd51edf0dc9a05294be196495df223385c',
        mimetype='text/plain')
